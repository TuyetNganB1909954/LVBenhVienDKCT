...
// app.use("/api", require('./routers/EquipmentRouter'))
app.use("/api", require('./routers/LichHenRouter'))
app.use("/api", require('./routers/BacSiRouter'))
app.use("/api", require('./routers/ChuyenKhoaRouter'))
app.use("/api", require('./routers/LichTrucRouter'))
